...
class TicTacToe:
    ...
    def print_board_nums():
        #    | 1 | 2 etc (tells us what number corresonds to what box)
    ...
    def winner(self, square, letter):
        # winner if 3 in a row anywhere.. we have to chack all of these!
...
def play(game, x_player, o_player, print_game=True):
    ...
    # iterate while the game has empty quares
    # (we don't have to worry about winner because we'll just return that
    # which brekas the loop)
